...
public class MusicMgr : BaseManager<MusicMgr>
{
    ...
    //背景音乐是否在播放
    private bool bkMusicIsPlay;
    //背景音乐大小
    private float bkMusicValue;
    ...
    private MusicMgr() 
    {
        ...
        bkMusicIsPlay = DataMgr.Instance.musicData.musicOpen;
        bkMusicValue = DataMgr.Instance.musicData.musicVolume;
        soundValue = DataMgr.Instance.musicData.soundVolume;
        soundIsPlay = DataMgr.Instance.musicData.soundOpen;
    }
    ...
    public void ChangeBKMusic(bool bkMusicIsPlay)
    {
        this.bkMusicIsPlay = bkMusicIsPlay;
    }
    ...
    public MusicData GetData()
    {
        ...
        data.Init(bkMusicIsPlay, soundIsPlay, bkMusicValue, soundValue);
        return data;
    }
